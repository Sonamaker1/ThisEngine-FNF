...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSectionUI():Void
	{
		...
		var mirrorButton3:FlxButton = new FlxButton(duetButton.x + 200, duetButton.y, "Duet Mirror", function()
		{
			var duetNotes:Array<Array<Dynamic>> = [];
			for (note in _song.notes[curSec].sectionNotes)
			{
				var noteNew = 3 - note[1]%4;
				if (note[1] > 3) noteNew += 4;
				...
				var copiedNote:Array<Dynamic> = [note[0], note[1], note[2], note[3]];
				note[1] = noteNew;
				duetNotes.push(copiedNote);
			}
		...
		var mirrorButton2:FlxButton = new FlxButton(duetButton.x + 100, duetButton.y+30, "Real Mirror", function()
		{
			var duetNotes:Array<Array<Dynamic>> = [];
			for (note in _song.notes[curSec].sectionNotes)
			{
				...
				note[1] = noteNew;
				var copiedNote:Array<Dynamic> = [note[0], noteNew, note[2], note[3]];
				//duetNotes.push(copiedNote);
			}
		...
		tab_group_section.add(mirrorButton2);
		tab_group_section.add(mirrorButton3);
